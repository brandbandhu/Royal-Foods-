...
export default function ContactPage() {
  ...
  return (
    <>
      <PageHero
        title="Contact Us"
        subtitle="Talk to Royal Foods for institutional catering, hostel mess management, bulk food supply, and customized meal planning."
        crumb="Contact"
      />
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid md:grid-cols-3 gap-6">
          {[
            ...
            <Reveal key={c.t} delay={i * 100}>
              <a
                href={c.href || "#"}
                className="block bg-white border border-border rounded-2xl p-6 hover-lift"
              >
                <div className="h-12 w-12 rounded-xl bg-gradient-brand grid place-items-center text-white shadow-soft">
            ...
            <Reveal>
              <div className="bg-white rounded-3xl shadow-card p-8 md:p-10">
                ...
                <p className="mt-2 text-muted-foreground">
                  Fill the form and our team will respond to your institutional food service
                  requirement.
                </p>
                <form onSubmit={onSubmit} className="mt-6 grid sm:grid-cols-2 gap-4">
                  ...
                  <Field label="Message" required className="sm:col-span-2">
                    <textarea
                      ...
                      rows={4}
                      className="input"
                      placeholder="Tell us about your institution, student count, meal requirement, dates..."
                    />
                  </Field>
                  <div className="sm:col-span-2 flex flex-wrap gap-3">
                    <button
                      type="submit"
                      disabled={sending}
                      className="inline-flex items-center gap-2 rounded-full bg-gradient-brand text-white px-7 py-3.5 font-semibold shadow-soft hover:scale-105 transition disabled:opacity-60 disabled:cursor-not-allowed"
                    >
                      {sending ? (
                        "Sending..."
                      ) : (
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-flex items-center gap-2 rounded-full bg-[#25D366] text-white px-6 py-3.5 font-semibold hover:scale-105 transition"
                    >
