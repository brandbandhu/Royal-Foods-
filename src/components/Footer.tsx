        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-white">
            <h3 className="font-display text-2xl font-bold">
              Need a trusted institutional food service partner?
            </h3>
            <p className="text-white/85 mt-1">
              Talk to Royal Foods for healthy food, quality service, and trusted experience.
            </p>
          </div>
          <div className="flex gap-3">
            <a
              href={`tel:${SITE.phoneRaw}`}
              className="inline-flex items-center gap-2 rounded-full bg-white text-primary px-5 py-3 font-semibold shadow-soft hover:scale-105 transition"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 rounded-full bg-[#25D366] text-white px-5 py-3 font-semibold shadow-soft hover:scale-105 transition"
            >
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14 grid gap-10 md:grid-cols-2 lg:grid-cols-4">
        <div>
          ...
          <p className="text-sm leading-relaxed text-slate-400">
            Professionally managed food service company with 25+ years of institutional catering
            experience, serving healthy and nutritious meals at MIT ADT University.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            {NAV.map((n) => (
              <li key={n.to}>
                <Link to={n.to} className="hover:text-cyan-300 transition">
                  {n.label}
                </Link>
              </li>
            ))}
          ...
          <ul className="space-y-3 text-sm">
            ...
            <li className="flex gap-3">
              ...
              <span>
                ...
                ,{" "}
                <a href={`tel:${SITE.phoneAltRaw}`} className="hover:text-cyan-300">
                  {SITE.phoneAlt}
                </a>
              </span>
            </li>
